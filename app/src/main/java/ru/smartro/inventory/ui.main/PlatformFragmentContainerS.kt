...
class PlatformFragmentContainerS(val p_platform_uuid: String) : AbstractFragment(){

    companion object {
        fun newInstance(platformUuid: String) = PlatformFragmentContainerS(platformUuid)
    }
    //
